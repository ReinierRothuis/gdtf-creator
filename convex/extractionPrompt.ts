...
export const extractionPromptAddenda = {
  "claude-haiku-native": "Preserve every distinct DMX mode. Prefer subFixtures for repeated pixel layouts to keep output compact.",
  "gemini-flash-lite-native": "Do not stop after representative channels: return every mode and its complete layout. Use subFixtures for repeated pixels. Treat LED COLOR and CCT preset tables as virtual color wheels.",
  "openai-gpt-nano-native": "Omit optional fields when unknown; never emit null, zero fineOf values, empty wheels, empty modes, or empty subFixtures. Keep every DMX mode separate. Use subFixtures for repeated pixels.",
